...
$config->APPID		= '202559';	//你的API Key，请自行申请
$config->APIKey		= '2a54958d53a84910842f3a734c030957';	//你的API Key，请自行申请
$config->SecretKey	= '60e787a4890e45d59d47962185de9f48';	//你的API 密钥
$config->APIVersion	= '1.0';	//当前API的版本号，不需要修改
$config->decodeFormat	= 'json';	//默认的返回格式，根据实际情况修改，支持：json,xml

$config->redirecturi= 'http://apps.renren.com/birthdates/';//授权成功之后的跳转地址
$config->scope='publish_feed,photo_upload,status_update';
?>